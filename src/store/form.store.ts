      ...
      configHelloForm: {
        ...
        fields: [
          ...
          },
          {
            ...
            attrs: { required: true, placeholder: 'Выберите из списка' },
          },
        ],
      ...
      configFeedbackForm: {
        ...
        fields: [
          ...
          },
          {
            ...
            type: 'select',
            name: 'mostImportant',
            options: ['Уровень дохода', 'Коллеги', 'Руководство', 'График работы', 'Место работы'],
            attrs: { multiple: true, placeholder: 'Выберите варианты' },
          },
          {
            key: 'message',
            label: 'Сообщение',
